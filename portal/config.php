...
define("APP_ID", "744776209355355a72051e18ebf7940c");
...
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['full_names'] : null ));
