                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-mobile_number"  value="<?php  echo $data['mobile_number']; ?>" type="text" placeholder="Enter Mobile Number"  required="" name="mobile_number"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
